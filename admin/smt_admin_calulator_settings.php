...
if ($calc_frm_id) {
    ...
    $shortcodeObj = new loanCalculator($get_calc_shortcode->shortcode_key);
...
if (isset($_POST['create_calc_shortcode_btn'])) {
    ...
    $msg = NULL;
    $redirect_to = SMART_CALC_ADMIN_PAGE;
    if (empty($calc_shortcode_key)) {
        ...
        $data = array(
            ...
            'options_dropmenu' => json_encode($save_with_defaults_attr->options),
        ...
        $new_obj = new loanCalculator($get_row->shortcode_key);
        ...
        $new_records->options->box_color = '#0F69A4';
        $new_records->options->text_color = '#FFFFFF';
        ...
        $update_data = array(
            ...
            'options_dropmenu' => json_encode($new_records->options),
        ...
        if ($ID) {
            $redirect_to = SMART_CALC_ADMIN_PAGE . '&calc_frm_id=' . $ID;
        }
    }
...
if (isset($_POST['smart_style_switcher_btn'])) {
    ...
    $months = $_POST['months'];
    $options_dropdown = $_POST['options_dropdown'];
    ...
    $newshortcodeObj = new loanCalculator($get_calc_shortcode->shortcode_key);
    ...
    $new_shortcode_settings->options->box_color = $options_dropdown['box_color'];
    $new_shortcode_settings->options->text_color = $options_dropdown['text_color'];
    ...
    $data = array(
        ...
        'options_dropmenu' => json_encode($new_shortcode_settings->options),
    ...
    wp_safe_redirect(SMART_CALC_ADMIN_PAGE . '&calc_frm_id=' . $calc_frm_id);
    exit;
}
...
if (isset($_POST['shortcode_settings_btn'])) {
    ...
    $amount = $_POST['amount'];
    $months = $_POST['months'];
    $options_dropdown = $_POST['options_dropmenu'];
    $percentage = $_POST['percentage'];
    $monthly_payment = $_POST['monthly_payment'];
    ...
    $new_shortcode_settings->options->title = $options_dropdown['title'];
    $new_shortcode_settings->options->dropmenu = $options_dropdown['options'];
...
<h2 class="smt_top_header"><?php echo $calc_shortcode_text; ?> Loan Calculator</h2>
<?php if (!$calc_frm_id): ?>
    <?php
    ...
    <form id="" name="shortcode_frm_settings" class="" method="post">
        <table class="widefat">
            ...
            <tr>
                <td>&nbsp;</td>
                <td>Generated Shortcode will be [smartcalc ID="test"]</td>
            </tr>
            <tr>
                <td>&nbsp;</td>
                <td>
...
<?php else : ?>
    ...
    $options_box_color = ($get_shortcode_settings->options->box_color != '') ? $get_shortcode_settings->options->box_color : '#ebf0f4';

    $options_text_color = ($get_shortcode_settings->options->text_color != '') ? $get_shortcode_settings->options->text_color : '#ffffff';
    ...
    <!-- <span class="edit-icon"><a class="smart_title_edit" href="#"><img src="<?php echo plugins_url() . '/smartcalculator/images/edit.png'; ?>"> Edit text</a></span> -->
                    ...
                    <div class="calc_settings_part">
                        ...
                        <div class="cals_form_field">
                            ...
                            <div class="calc-btn"><a href="#" id="smt_currency_add">+ Add</a></div>
                            <div class="add_select_wrap">
                                <?php if (is_array($get_shortcode_settings->currency->dropmenu) && count($get_shortcode_settings->currency->dropmenu) > 0) : ?>
                                    <?php
                                    $i = 0;
                                    foreach ($get_shortcode_settings->currency->dropmenu as $opt) :
                                        ?>
                                        <div class="add_select_box currency_box">
                                            <input type="text" name="currency[options][<?php echo $i; ?>]" value="<?php echo $opt; ?>" data-placeholder="USD,$,min,max" placeholder="USD,$,min,max">
                                            <a href="#" class="del_options_val"><img src="<?php echo SMART_CALC_URL . 'images/cross.png'; ?>"></a>
                                        </div>
                                        <?php
                                        $i++;
                                    endforeach;
                    ...
                    <div class="calc_settings_part">
                        ...
                        <div class="twopart_section">
                            <div class="cals_field-left">                     
                                <!--                                <div class="cals_form_field">
                                                                    <label>Set minimum amount</label>  
                                                                    <input class="shortcode_sett_title" name="amount[min]" type="text" value="<?php echo $get_shortcode_settings->amount->min; ?>" data-placeholder="5,000.00" placeholder="5,000.00">
                                                                     <span class="edit-icon"><a class="smart_title_edit" href="#"><img src="<?php echo plugins_url() . '/smartcalculator/images/edit.png'; ?>"> Edit text</a></span> 
                                                                </div>-->
                                <div class="cals_form_field">
                                    <label>Set minimum error message</label>
                                    <textarea class="shortcode_sett_title" name="amount[min_error_msg]" data-placeholder="You have spend the minimum amount" placeholder="You have spend the minimum amount"><?php echo $get_shortcode_settings->amount->min_error_msg; ?></textarea>
                            ...
                            <div class="cals_field-left">                     
                                <!--                                <div class="cals_form_field">
                                                                    <label>Set maximum amount</label>  
                                                                    <input type="text" class="shortcode_sett_title" name="amount[max]" value="<?php echo $get_shortcode_settings->amount->max; ?>" data-placeholder="12,000,000.00" placeholder="12,000,000.00">
                                                                     <span class="edit-icon"><a class="smart_title_edit" href="#"><img src="<?php echo plugins_url() . '/smartcalculator/images/edit.png'; ?>"> Edit text</a></span> 
                                                                </div>-->
                                <div class="cals_form_field">
                                    <label>Set maximum error message</label>
                                    <textarea class="shortcode_sett_title" name="amount[max_error_msg]" data-placeholder="You have spend the maximum amount" placeholder="You have spend the maximum amount"><?php echo $get_shortcode_settings->amount->max_error_msg; ?></textarea>
                                    <!-- <span class="edit-icon edit_align_middle"><a class="smart_title_edit" href="#"><img src="<?php echo plugins_url() . '/smartcalculator/images/edit.png'; ?>"> Edit text</a></span> -->
                                </div>
                            </div>
                    ...
                    <div class="calc_settings_part">
                        ...
                        <div class="twopart_section">
                            <div class="cals_field-left">                     
                                <div class="cals_form_field">
                                    <label>Set minimum period</label>  
                                    <input name="months[min]" type="text" value="<?php echo $get_shortcode_settings->months->min; ?>" class="shortcode_sett_title" data-placeholder="6" placeholder="6">
                                    <!-- <span class="edit-icon"><a class="smart_title_edit" href="#"><img src="<?php echo plugins_url() . '/smartcalculator/images/edit.png'; ?>"> Edit text</a></span> -->
                                </div>
                                <div class="cals_form_field">
                                    <label>Set minimum error message</label>
                                    <textarea name="months[min_error_msg]"class="shortcode_sett_title" data-placeholder="Minimum period allow is 6 months." placeholder="Minimum period allow is 6 months."><?php echo $get_shortcode_settings->months->min_error_msg; ?></textarea>
                                    <!-- <span class="edit-icon edit_align_middle"><a class="smart_title_edit" href="#"><img src="<?php echo plugins_url() . '/smartcalculator/images/edit.png'; ?>"> Edit text</a></span> -->
                                </div>
                            </div>
                            <div class="cals_field-left">                     
                                <div class="cals_form_field">
                                    <label>Set maximum period</label>  
                                    <input name="months[max]" type="text" value="<?php echo $get_shortcode_settings->months->max; ?>" class="shortcode_sett_title" data-placeholder="120" placeholder="120">
                                    <!-- <span class="edit-icon"><a  class="smart_title_edit"href="#"><img src="<?php echo plugins_url() . '/smartcalculator/images/edit.png'; ?>"> Edit text</a></span> -->
                                </div>
                                <div class="cals_form_field">
                                    <label>Set maximum error message</label>
                                    <textarea name="months[max_error_msg]" class="shortcode_sett_title" data-placeholder="Minimum period allow is 120 months." placeholder="Minimum period allow is 120 months."><?php echo $get_shortcode_settings->months->max_error_msg; ?></textarea>
                                    <!-- <span class="edit-icon edit_align_middle"><a class="smart_title_edit" href="#"><img src="<?php echo plugins_url() . '/smartcalculator/images/edit.png'; ?>"> Edit text</a></span> -->
                                </div>
                            </div>
                            <div class="clear"></div>
                    ...
                    <div class="calc_settings_part">
                        <h2>Guarantee Box</h2>
                        <div class="cals_form_field">
                            <label>Set guarantee box title</label>
                            <input type="text" class="shortcode_sett_title" name="options_dropmenu[title]" value="<?php echo $get_shortcode_settings->options->title; ?>" data-placeholder="Enter Options title" placeholder="Enter Options title">
                            <!-- <span class="edit-icon"><a class="smart_title_edit" href="#"><img src="<?php echo plugins_url() . '/smartcalculator/images/edit.png'; ?>"> Edit text</a></span> -->
                        </div>
                        <div class="cals_form_field">
                            <label>Add option</label>
                            <div class="calc-btn"><a href="#" id="smt_add_percenatge">+ Add</a></div>
                            <div class="add_select_wrap">
                                <?php if (is_array($get_shortcode_settings->options->dropmenu) && count($get_shortcode_settings->options->dropmenu) > 0) : ?>
                                    <?php
                                    $j = 0;
                                    foreach ($get_shortcode_settings->options->dropmenu as $opt) :
                                        ?>
                                        <div class="add_select_box options_box">
                                            <input data-placeholder="Mortgage,10%" placeholder="Mortgage,10%" type="text" name="options_dropmenu[options][<?php echo $j; ?>]" value="<?php echo $opt; ?>">
                                            <a href="#" class="del_options_val"><img src="<?php echo SMART_CALC_URL . 'images/cross.png'; ?>"></a>
                                        </div>
                                        <?php
                                        $j++;
                            ...
                            <div class="pick-color-sec">
                                ...
                                <ul class="pick-color-inner">
                                    ...
                                    <li>
                                        ...
                                        <div class="sh_witcher pick-color-input"><input type="text" data-change="color" data-id="preview_options" style="background: <?php echo $get_shortcode_settings->options->text_color; ?>" name="options_dropdown[text_color]" class="" value="<?php echo $get_shortcode_settings->options->text_color; ?>"></div>
                                    </li>
                                    <li>
                                        <label>Options box color</label>
                                        <div class="sh_witcher pick-color-input"><input type="text" data-change="background" data-id="preview_options" style="background: <?php echo $get_shortcode_settings->options->box_color; ?>" name="options_dropdown[box_color]" class="" value="<?php echo $get_shortcode_settings->options->box_color; ?>"></div>
                                    </li>
                                    <li>
                                ...
                                <div class="smart_calc_wrapper" id="preview_background" style=" width:550px; background:<?php echo $background_style; ?>; padding-bottom: 50px;">
                                    ...
                                    <div class="smart_calc_main_form" style="">
                                        <div class="smart_calc_top" id="preview_top_box" style="background:<?php echo $get_shortcode_settings->monthly_payment->box_color; ?>; padding: 15px 0 0 0;">
                                            ...
                                            <div class="smart_calc_sec">
                                                <div class="button custom-select ff-hack">
                                                    <label class="calc-label" style=""><img src="<?php echo SMART_CALC_URL; ?>/images/icon-option.png" /></label>
                                                    <select id="preview_options" class="smart_opt_selectbox" name="smart_options" style="color:#fff !important;">
                                        ...
                                        <div class="smart_calc_bottom" id="preview_payment_box" style="background: #ffffff;padding:15px; matgin-top:15px;">
